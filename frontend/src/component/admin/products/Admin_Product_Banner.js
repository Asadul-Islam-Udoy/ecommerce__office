...
import { ProductCreateAction, ResetProductAction, homeBannerCreateAction, homeBannerGetAction } from '../../../actions/ProductAction';
...
function Admin_Product_Banner({setCreateBannerProduct}) {
    ...
    const{lodding,error,isBanner,banners} = useSelector(state=>state.bannerStore)
                ...
                <form className='create__banner__from' onSubmit={CreateHandler}>
                  <div>
                    <div>
                        ...
                        <input multiple type='file' required onChange={handlerChange}/>
                    </div>
