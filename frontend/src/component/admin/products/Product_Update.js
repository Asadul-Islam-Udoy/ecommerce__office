...
import { ProductSingleAction, ProductUpdateAction, ResetProductAction } from '../../../actions/ProductAction';
...
function Product_Update({setUpdateProduct,productId}) {
    ...
    const{lodding,error,isProductUpdate,products} = useSelector(state=>state.ProductCreateReducer);
                ...
                <form className='create__from' onSubmit={updateHandler}>
                      ...
                      <summary style={{width:'200px'}} >Select Colors</summary>
                        <div style={{
                            ...
                            overflow:'scroll'
                             ...
                             {colors.map((i)=>(
                              <p><Checkbox  value={i.name} onChange={colorHandler} {...label} defaultChecked={product?.colors?.includes(i.name)} size="small" />{i.name}</p>
                             ))}
                        </div>
                       </details>
                    </div>
                      ...
                      <summary style={{width:'200px'}} >Select Size</summary>
                        <div style={{
                            ...
                            overflow:'scroll'
                             ...
                             {sizes.map((i)=>(
                              <p><Checkbox  value={i.name} onChange={sizeHandler}  defaultChecked={product?.sizes?.includes(i.name)} size="small" />{i.name}</p>
                             ))}
                        </div>
                       </details>
                    </div>
                  ...
                  <div>
                    ...
                    <div>
                        ...
                        <input multiple type='file' onChange={(e)=>setImage(e.target.files)}/>
                    </div>
                    <div>
                  ...
                  <div className='button__section'>
                     <button disabled={button} type='submit'>Update Product</button>
                  </div>
                  </div>
                 <div>
                   <div className='show__image'>
                    ...
                    <p>New Images</p>}
                    {
                        newImage.length >0 && newImage.map((item)=>(
