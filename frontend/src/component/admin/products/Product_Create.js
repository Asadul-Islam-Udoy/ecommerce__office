...
import { ProductCreateAction, ResetProductAction } from '../../../actions/ProductAction';
...
function Product_Create({setCreateProduct}) {
    ...
    const{lodding,error,products,isProducts} = useSelector(state=>state.ProductCreateReducer)
              ...
              <div className='create__container'>
                ...
                <form className='create__from' onSubmit={CreateHandler}>
                  <div>
                    ...
                    <div>
                    <details>
                      <summary style={{width:'200px'}} >Select Size</summary>
                        <div style={{
                            position:'absolute',
                            ...
                            overflow:'scroll'
                             ...
                             {sizes.map((i)=>(
                              <p><Checkbox  value={i.name} onChange={sizeHandler} {...label} defaultChecked={false} size="small" />{i.name}</p>
                             ))}
                        </div>
                       </details>
                    </div>
                    <div>
                    <details>
                      <summary style={{width:'200px'}} >Select Colors</summary>
                        <div style={{
                            position:'absolute',
                            backgroundColor:'gray',
                            width:'170px',
                            ...
                            overflow:'scroll'
                             ...
                             {colors.map((i)=>(
                              <p><Checkbox  value={i.name} onChange={colorHandler} {...label} defaultChecked={false} size="small" />{i.name}</p>
                             ))}
                        </div>
                       </details>
                    </div>
                  ...
                  <div>
                    <div>
                        ...
                        <input type='number' value={height} onChange={(e)=>setHeight(e.target.value)} placeholder='product height....'/>
                    </div>
                    <div>
                        <label>Product Width</label>
                        <input type='number'  value={width} onChange={(e)=>setWidth(e.target.value)} placeholder='product width....'/>
                    </div>
                    <div>
                        <label>Product Price</label>
                        <input type='number' required value={price} onChange={(e)=>setPrice(e.target.value)} placeholder='product price....'/>
                    </div>
                  </div>
                  <div>
                    <div>
                        <label>Product Offer</label>
                        <input type='number' value={offer} onChange={(e)=>setOffer(e.target.value)} placeholder='product offer....'/>
                    </div>
                    <div>
                        <label>Product Images</label>
                        <input multiple type='file' required onChange={(e)=>setImage(e.target.files)}/>
                    </div>
                    <div>
                        <label>Product Stock</label>
                        <input type='number' required value={stock} onChange={(e)=>setStock(e.target.value)} placeholder='product Stock....'/>
                    </div>
                  </div>
                  <div>
                   ...
                   >
                    <select value={categoriId}  onChange={(e)=>setCategoriId(e.target.value)} style={{width:'200px',padding:'6px'}}>
                  ...
                  <div className='button__section'>
                     <button disabled={button} type='submit'>Add Product</button>
                  </div>
                  </div>
                 <div>
