      ...
      <div className='footer__container'>
        ...
        <div className=' footer__box footer__box_1'>
            ...
            <div className='footer__box__1__right'>
               <p>SOCIAL MEDIA</p>
               <div>
                 <Link><img src='https://image.similarpng.com/very-thumbnail/2020/12/Popular-Facebook-icon-in-round-black-color-on-transparent-background-PNG.png' alt='im' /></Link>  
                 ...
                 <Link><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW0Sr3EXfFa0kChCM1dXVmlwB_-dfUtfm8eTdzZ4g08vvcaRWHLGliASgQuoZxRLM7wSQ&usqp=CAU' alt='im'/></Link> 
              </div>
          </div>
        </div>
