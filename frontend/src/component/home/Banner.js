...
const{banners} = useSelector(state=>state.bannerStore);
console.log('bannser',banners)
useEffect(()=>{
       ...
       <div className='banner__image__container'>
        <div className='banner__image__box'>
            <div className='banner__contan'>
                ...
                <p className='well__come'>Well Come! Everyone This is Web Side </p>
            </div>
          ...
          <div className='banner__button'>
            <p onClick={()=>setc_image((pre)=>pre-1)}><ArrowBackIosIcon/></p>
            <p onClick={()=>setc_image((pre)=>pre+1)}><ArrowForwardIosIcon/></p>
          </div>
        </div>
      </div>
    </>
